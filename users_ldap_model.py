...
class CompanyLDAP(orm.Model):
    ...
    _columns = {
        'firstname_attribute': fields.char(
            'Firstame Attribute', size=64,
            help="By default 'givenName' is used. "),
        'lastname_attribute': fields.char(
            'Lastname Attribute', size=64,
            help="By default 'sn' is used. "),
